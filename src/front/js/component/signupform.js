...
export const SignupForm = () => {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            inputEmail: Yup.string().email('Email inválido').required('El email es obligatorio'),
            inputPassword: Yup.string().max(8, 'Debe tener 8 caracteres máximo').min(6, 'Debe tener 6 caracteres mínimo').required('La contraseña es obligatoria'),
        }),
        onSubmit: values => {
